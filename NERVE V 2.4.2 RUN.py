        ...
        for frame in camera.capture_continuous(rawCapture, format="bgr", use_video_port=True):
            ...
            if PIR == 0:
                if (char == Q_Key):
                    ...
                    Data=input("Enter Route Name : ")
                elif (char == UP_Key) and (Mode==1) and (ALCHOLE ==1):
                    if i==1 :
                        stop = time.time()
                    ...
                    print('Forward')
                    i=1
                elif (char == Down_Key )and(Mode==1)and (ALCHOLE ==1):
                    if i==1 :
                        stop = time.time()
                        delay.write(str(stop-start)+'\n')
                    start = time.time()
                    ...
                    print('Backward')
                    i=1
                elif (char == Right_Key)and(Mode==1)and (ALCHOLE ==1):
                    if i==1 :
                        stop = time.time()
                        delay.write(str(stop-start)+'\n')
                    start = time.time()
                    ...
                    String ='Right'
                    print('Right')
                elif (char == Left_Key)and(Mode==1)and (ALCHOLE ==1):
                    if i ==1:
                        stop = time.time()
                        delay.write(str(stop-start)+'\n')
                    start = time.time()
                    ...
                    print('Left')
                    i=1
                elif (char == Enter_Key)and(Mode==1)and (ALCHOLE ==1):
                    if i ==1:
                        stop = time.time()
                        delay.write(str(stop-start)+'\n')
                    start = time.time()
