# NERVE V2.4 TEST is Deigned by Dheeraj Sharma at 12 August 2019 4:41(IST) without audio.
...
def Dheeraj_Sharma():
    Mode =0
    File_Status = 0
    start =0.00;stop =0.00;i=0;time_mode=0;run=0;PIR_Mode=0;time_start=0.00;time_stop=0.00
